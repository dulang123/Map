...
public class Map {
    ...
    public static class Reduce extends
        ...
        // 实现reduce函数
            ...
            while (iterator.hasNext()) {
                sum = iterator.next().get()+sum;// 计算总分
                count++;// 统计总的科目数
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] ioArgs = new String[] { "C:\\Users\\Administrator.PC-20180801PYJE\\score","C:\\Users\\Administrator.PC-20180801PYJE\\ssx"};
